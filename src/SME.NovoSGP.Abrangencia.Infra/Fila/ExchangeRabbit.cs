...
{
    public static string WorkerAbrangencia => "sme.sgp.workers";
    public static string WorkerAbrangenciaDeadLetter => "sme.sgp.workers.deadletter";
    public static string Logs => "EnterpriseApplicationLog";
    public static int WorkerAbrangenciaDeadLetterTtl => 600000; /*10 Min * 60 Seg * 1000 milisegundos = 10 minutos em milisegundos*/
